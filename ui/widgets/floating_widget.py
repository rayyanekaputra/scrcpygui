...
from core.adb_manager import FNM
...
class FloatingWidget(ctk.CTkToplevel):
    ...
    def __init__(self, parent, on_toggle, on_screenshot, visible: bool = True):
        ...
        # Root frame
        self.root_frame = tk.Frame(self, bg=adb_manager.CARD)
        ...
        # Separator
        tk.Frame(self.root_frame, bg=adb_manager.BDR, width=1).pack(side="left", fill="y")
